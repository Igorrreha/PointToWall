...
# 	3 - длительность импульса пульсаций
# 	4 - шанс переворота поля 
var states = [
	[0, 0, 0, 0.4, 0.0], 
	[5, 0.01, 1, 0.2, 0.2], 
	[20, 0.01, 1, 0.2, 0.5], 
...
func _ready():
	pulsationTweenNode = $PulsationTween
...
func pulse_the_scale():
	...
	pulsationTweenNode.interpolate_property(self, "scale", scale * 1.05, scale, impulseDuration, Tween.TRANS_LINEAR, Tween.EASE_OUT)
